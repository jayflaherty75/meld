...
declare function test cdecl (interfacePtr as any ptr, describeFn as Tester.describeCallback) as short
declare function run cdecl (tests as testModule ptr, interfacePtr as any ptr, count as short) as short
